...
This document covers the media/system/conversion exports currently present in `@open-agents/natives`: terminal SIXEL image encoding, HTML conversion, clipboard access, token counting, macOS appearance/power helpers, and work profiling.
