...
2. Managed venv at `~/.open-agent/python-env`
...
- **No Python on PATH** — Install a system Python 3.8+ or place a venv at `~/.open-agent/python-env`. `open-agent setup python --check` reports the resolved interpreter.
