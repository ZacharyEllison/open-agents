...
- syntax highlighting colors used by native highlighter (`@open-agents/natives`)
...
- default: `~/.open-agent/agent/themes`
- overridden by `OA_AGENT_DIR` (`$OA_AGENT_DIR/themes`)
...
- default agent dir: `~/.open-agent/agent`
- effective default file: `~/.open-agent/agent/config.yml`
...
1. Create file in custom themes dir, e.g. `~/.open-agent/agent/themes/my-theme.json`.
