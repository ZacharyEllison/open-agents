...
import { buildOpenAiNativeHistory, requestOpenAiRemoteCompaction } from "@open-agents/agent/compaction/openai";
import type { AssistantMessage, Model, ToolResultMessage } from "@open-agents/ai/types";
