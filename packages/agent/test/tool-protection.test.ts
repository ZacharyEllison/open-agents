...
import type { SessionMessageEntry } from "@open-agents/agent/compaction/entries";
import { DEFAULT_PRUNE_CONFIG, pruneToolOutputs } from "@open-agents/agent/compaction/pruning";
import { AGGRESSIVE_SHAKE_CONFIG, collectShakeRegions } from "@open-agents/agent/compaction/shake";
import type { AssistantMessage, TextContent, ToolResultMessage, Usage } from "@open-agents/ai";
