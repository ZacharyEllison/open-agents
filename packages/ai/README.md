...
```typescript
import { z, getModel, stream, complete, Context, Tool } from "@open-agents/ai";
...
```typescript
import { z, Tool } from "@open-agents/ai";
...
```typescript
import { stream, validateToolCall, Tool } from "@open-agents/ai";
...
```typescript
import * as fs from "node:fs";
import { getModel, complete } from "@open-agents/ai";
...
```typescript
import { getModel, streamSimple, completeSimple } from "@open-agents/ai";
...
```typescript
import { getModel, stream } from "@open-agents/ai";
...
```typescript
import { getProviders, getModels, getModel } from "@open-agents/ai";
...
```typescript
import { Model, stream } from "@open-agents/ai";
...
```typescript
import { getModel, complete, Context } from "@open-agents/ai";
...
```typescript
import { Context, getModel, complete } from "@open-agents/ai";
...
```typescript
import { getEnvApiKey } from "@open-agents/ai";
...
Authenticate via the [`omp`](https://github.com/ZacharyEllison/open-agents) coding-agent CLI, which drives this library's OAuth/API-key flows in-process and persists into `agent.db`:
...
```typescript
import { loginGitHubCopilot } from "@open-agents/ai";
import * as fs from "node:fs";
...
```typescript
import { getModel, complete, getOAuthApiKey } from "@open-agents/ai";
import * as fs from "node:fs";
