...
import type { CompactionPreparation, CompactionResult } from "@open-agents/agent/compaction";
import type { ImageContent, TextContent, ToolResultMessage } from "@open-agents/ai";
