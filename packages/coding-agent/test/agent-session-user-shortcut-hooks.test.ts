...
import * as bashExecutor from "@open-agents/coding-agent/exec/bash-executor";
import type { ExtensionRunner } from "@open-agents/coding-agent/extensibility/extensions";
