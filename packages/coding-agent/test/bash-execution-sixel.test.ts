...
import { BashExecutionComponent } from "@open-agents/coding-agent/modes/components/bash-execution";
import { getThemeByName, setThemeInstance } from "@open-agents/coding-agent/modes/theme/theme";
import { sanitizeWithOptionalSixelPassthrough } from "@open-agents/coding-agent/utils/sixel";
