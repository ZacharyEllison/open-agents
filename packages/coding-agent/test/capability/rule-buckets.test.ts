...
import { BUILTIN_DEFAULTS_PROVIDER_ID, type Rule } from "@open-agents/coding-agent/capability/rule";
import { bucketRules } from "@open-agents/coding-agent/capability/rule-buckets";
