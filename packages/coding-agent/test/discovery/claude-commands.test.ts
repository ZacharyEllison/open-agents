...
import { type SlashCommand, slashCommandCapability } from "@open-agents/coding-agent/capability/slash-command";
import { resetSettingsForTest } from "@open-agents/coding-agent/config/settings";
import { loadCapability } from "@open-agents/coding-agent/discovery";
