...
import { loadCapability } from "@open-agents/coding-agent/capability";
import { clearCache as clearFsCache } from "@open-agents/coding-agent/capability/fs";
import {
	clearClaudePluginRootsCache,
	listClaudePluginRoots,
	parseClaudePluginsRegistry,
} from "@open-agents/coding-agent/discovery/helpers";
import { discoverAgents } from "@open-agents/coding-agent/task/discovery";
import "@open-agents/coding-agent/discovery/claude-plugins";
import type { Skill } from "@open-agents/coding-agent/capability/skill";
import type { SlashCommand } from "@open-agents/coding-agent/capability/slash-command";
