...
import { type ContextFile, contextFileCapability } from "@open-agents/coding-agent/capability/context-file";
import { resetSettingsForTest, Settings } from "@open-agents/coding-agent/config/settings";
import { initializeWithSettings, loadCapability } from "@open-agents/coding-agent/discovery";
