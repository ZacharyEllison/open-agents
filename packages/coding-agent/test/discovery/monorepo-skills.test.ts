...
import type { LoadContext, LoadResult } from "@open-agents/coding-agent/capability/types";
import { scanSkillsFromDir } from "@open-agents/coding-agent/discovery/helpers";
