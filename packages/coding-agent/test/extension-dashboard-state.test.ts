...
import { applyDisabledExtensionsToState } from "@open-agents/coding-agent/modes/components/extensions/state-manager";
import type { DashboardState, Extension } from "@open-agents/coding-agent/modes/components/extensions/types";
