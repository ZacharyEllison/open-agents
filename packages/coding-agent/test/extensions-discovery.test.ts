...
import { discoverAndLoadExtensions, loadExtensions } from "@open-agents/coding-agent/extensibility/extensions/loader";
import { getProjectAgentDir, TempDir } from "@open-agents/utils";
