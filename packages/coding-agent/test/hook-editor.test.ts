...
import { HookEditorComponent } from "@open-agents/coding-agent/modes/components/hook-editor";
import { ExtensionUiController } from "@open-agents/coding-agent/modes/controllers/extension-ui-controller";
...
import { setKeybindings, type TUI } from "@open-agents/tui";
