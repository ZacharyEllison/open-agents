...
import { HookSelectorComponent } from "@open-agents/coding-agent/modes/components/hook-selector";
import { getThemeByName, setThemeInstance, theme } from "@open-agents/coding-agent/modes/theme/theme";
