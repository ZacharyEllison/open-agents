...
import { KeybindingsManager } from "@open-agents/coding-agent/config/keybindings";
import { ExtensionList } from "@open-agents/coding-agent/modes/components/extensions/extension-list";
import type { Extension } from "@open-agents/coding-agent/modes/components/extensions/types";
import { HistorySearchComponent } from "@open-agents/coding-agent/modes/components/history-search";
import { SessionSelectorComponent } from "@open-agents/coding-agent/modes/components/session-selector";
import { TreeSelectorComponent } from "@open-agents/coding-agent/modes/components/tree-selector";
import { UserMessageSelectorComponent } from "@open-agents/coding-agent/modes/components/user-message-selector";
import { initTheme } from "@open-agents/coding-agent/modes/theme/theme";
import { HistoryStorage } from "@open-agents/coding-agent/session/history-storage";
import type { SessionInfo, SessionTreeNode } from "@open-agents/coding-agent/session/session-manager";
import { setKeybindings } from "@open-agents/tui";
