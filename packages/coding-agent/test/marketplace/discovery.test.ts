 ...
 * @open-agents/natives (native Rust addon via glob). We cannot call it here.
 *
...
import type { InstalledPluginEntry } from "@open-agents/coding-agent/extensibility/plugins/marketplace";
import {
	addInstalledPlugin,
	buildPluginId,
	readInstalledPluginsRegistry,
	writeInstalledPluginsRegistry,
} from "@open-agents/coding-agent/extensibility/plugins/marketplace";

// ── Inline validator ───────────────────────────────────────────────────────────
//
// Mirrors parseClaudePluginsRegistry() in discovery/helpers.ts exactly.
// Kept here to avoid importing helpers.ts (which pulls in @open-agents/natives).
...
// Matches getConfigDirName() — single source of truth is in @open-agents/utils,
