...
import type { MarketplacePluginEntry } from "@open-agents/coding-agent/extensibility/plugins/marketplace";
import { resolvePluginSource } from "@open-agents/coding-agent/extensibility/plugins/marketplace";
