...
import { Effort, type Model, type OpenAICompat, type ThinkingConfig, writeModelCache } from "@open-agents/ai";
import { kNoAuth, ModelRegistry } from "@open-agents/coding-agent/config/model-registry";
