...
import type { AssistantThinkingRenderer } from "@open-agents/coding-agent/extensibility/extensions";
import { AssistantMessageComponent } from "@open-agents/coding-agent/modes/components/assistant-message";
import { clearMermaidCache } from "@open-agents/coding-agent/modes/theme/mermaid-cache";
import { initTheme } from "@open-agents/coding-agent/modes/theme/theme";
import { ImageProtocol, setTerminalImageProtocol, TERMINAL, Text } from "@open-agents/tui";
