...
import { discoverAndLoadExtensions } from "@open-agents/coding-agent/extensibility/extensions/loader";
import { getAgentDir, getPluginsDir, setAgentDir, TempDir } from "@open-agents/utils";

const currentPiCodingAgentPath = Bun.resolveSync("@open-agents/coding-agent", import.meta.dir);
const currentPiExtensionsPath = Bun.resolveSync("@open-agents/coding-agent/extensibility/extensions", import.meta.dir);
