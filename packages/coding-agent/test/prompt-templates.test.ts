...
import { expandPromptTemplate, type PromptTemplate } from "@open-agents/coding-agent/config/prompt-templates";
import { expandSlashCommand, type FileSlashCommand } from "@open-agents/coding-agent/extensibility/slash-commands";
import { parseCommandArgs, substituteArgs } from "@open-agents/coding-agent/utils/command-args";
