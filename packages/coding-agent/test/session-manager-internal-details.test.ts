...
import { type SkillPromptDetails, stripInternalDetailsFields } from "@open-agents/coding-agent/session/messages";
import { type CustomMessageEntry, SessionManager } from "@open-agents/coding-agent/session/session-manager";
