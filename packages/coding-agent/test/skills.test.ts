...
import { type Skill as CapabilitySkill, skillCapability } from "@open-agents/coding-agent/capability/skill";
import { getCapability } from "@open-agents/coding-agent/discovery";
import { loadSkills, loadSkillsFromDir, type Skill } from "@open-agents/coding-agent/extensibility/skills";
