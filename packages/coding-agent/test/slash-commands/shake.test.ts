...
import type { ShakeMode } from "@open-agents/coding-agent/session/shake-types";
import {
	ACP_BUILTIN_SLASH_COMMANDS,
	executeAcpBuiltinSlashCommand,
} from "@open-agents/coding-agent/slash-commands/acp-builtins";
import { executeBuiltinSlashCommand } from "@open-agents/coding-agent/slash-commands/builtin-registry";
import type { SlashCommandRuntime } from "@open-agents/coding-agent/slash-commands/types";
