...
import type { completeSimple, Model } from "@open-agents/ai";
...
import { InspectImageTool } from "@open-agents/coding-agent/tools/inspect-image";
import { inspectImageToolRenderer } from "@open-agents/coding-agent/tools/inspect-image-renderer";
