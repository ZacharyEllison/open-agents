...
import type { FileDiagnosticsResult } from "@open-agents/coding-agent/lsp";
import { DiagnosticsLedger, diagnosticIdentity } from "@open-agents/coding-agent/lsp/diagnostics-ledger";
