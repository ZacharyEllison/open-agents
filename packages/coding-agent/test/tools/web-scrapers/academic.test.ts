...
import { handleArxiv } from "@open-agents/coding-agent/web/scrapers/arxiv";
import { handleIacr } from "@open-agents/coding-agent/web/scrapers/iacr";
import { handlePubMed } from "@open-agents/coding-agent/web/scrapers/pubmed";
import { handleSemanticScholar } from "@open-agents/coding-agent/web/scrapers/semantic-scholar";
import type { RenderResult } from "@open-agents/coding-agent/web/scrapers/types";
