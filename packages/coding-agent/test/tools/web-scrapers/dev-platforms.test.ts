...
import { handleDevTo } from "@open-agents/coding-agent/web/scrapers/devto";
import { handleGitLab } from "@open-agents/coding-agent/web/scrapers/gitlab";
import { handleHackerNews } from "@open-agents/coding-agent/web/scrapers/hackernews";
import { handleLobsters } from "@open-agents/coding-agent/web/scrapers/lobsters";
