...
import { handleArtifactHub } from "@open-agents/coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@open-agents/coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@open-agents/coding-agent/web/scrapers/discogs";
