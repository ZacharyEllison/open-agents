...
import { handleHuggingFace } from "@open-agents/coding-agent/web/scrapers/huggingface";
import { handleSpotify } from "@open-agents/coding-agent/web/scrapers/spotify";
import { handleVimeo } from "@open-agents/coding-agent/web/scrapers/vimeo";
