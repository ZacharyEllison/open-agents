...
import { handleAur } from "@open-agents/coding-agent/web/scrapers/aur";
import { handleBrew } from "@open-agents/coding-agent/web/scrapers/brew";
import { handleMaven } from "@open-agents/coding-agent/web/scrapers/maven";
import { handleNuGet } from "@open-agents/coding-agent/web/scrapers/nuget";
import { handlePackagist } from "@open-agents/coding-agent/web/scrapers/packagist";
import { handleRubyGems } from "@open-agents/coding-agent/web/scrapers/rubygems";
