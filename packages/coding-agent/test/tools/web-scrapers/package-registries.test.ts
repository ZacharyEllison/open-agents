...
import { handleCratesIo } from "@open-agents/coding-agent/web/scrapers/crates-io";
import { handleGoPkg } from "@open-agents/coding-agent/web/scrapers/go-pkg";
import { handleHex } from "@open-agents/coding-agent/web/scrapers/hex";
import { handleNpm } from "@open-agents/coding-agent/web/scrapers/npm";
import { handlePubDev } from "@open-agents/coding-agent/web/scrapers/pub-dev";
import { handlePyPI } from "@open-agents/coding-agent/web/scrapers/pypi";
