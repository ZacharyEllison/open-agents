...
import { handleBiorxiv } from "@open-agents/coding-agent/web/scrapers/biorxiv";
import { handleOpenLibrary } from "@open-agents/coding-agent/web/scrapers/openlibrary";
import { handleWikidata } from "@open-agents/coding-agent/web/scrapers/wikidata";
