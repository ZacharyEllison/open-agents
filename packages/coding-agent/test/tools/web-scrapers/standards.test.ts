...
import { handleCheatSh } from "@open-agents/coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@open-agents/coding-agent/web/scrapers/rfc";
import { handleTldr } from "@open-agents/coding-agent/web/scrapers/tldr";
