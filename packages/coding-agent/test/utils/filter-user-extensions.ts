...
import { getAgentDir, getConfigRootDir, getPluginsDir } from "@open-agents/utils";
...
// 2. `getAgentDir()` (`~/.omp/agent` or `$OA_AGENT_DIR`)
//    Handles `OA_AGENT_DIR` overrides that relocate the agent dir
