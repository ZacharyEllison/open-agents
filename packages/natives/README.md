...
```typescript
import { grep, find, encodeSixel } from "@open-agents/natives";
...
`@open-agents/natives` publishes a small core package plus generated
...
npm/<platform>-<arch>/   # Generated at publish time, not committed
  package.json           # @open-agents/natives-<platform>-<arch>
