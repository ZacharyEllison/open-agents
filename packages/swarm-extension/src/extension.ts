 ...
 * then use /swarm in any open-agent session.
 */

import * as fs from "node:fs/promises";
import * as path from "node:path";
import type { AuthStorage, ExtensionAPI, ExtensionCommandContext } from "@open-agents/coding-agent";
import { formatDuration } from "@open-agents/utils";
