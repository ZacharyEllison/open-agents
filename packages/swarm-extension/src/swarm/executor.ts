/**
 * Swarm agent execution via open-agent's subagent infrastructure.
 *
...
import { runSubprocess } from "@open-agents/coding-agent";
...
/**
 * Execute a single swarm agent as an open-agent subagent.
 *
 * The agent receives:
